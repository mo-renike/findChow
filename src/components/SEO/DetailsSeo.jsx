...
const DetailsSeo = ({ spot }) => {
    return (
        <Helmet>
            ...
            />
            <link rel="canonical" href={`https://everything-amala.vercel.app/place/${spot.place_id}`} />
            ...
            />
            <meta property="og:url" content={`https://everything-amala.vercel.app/place/${spot.place_id}`} />
            <meta
                property="og:image"
                content={spot.icon ? spot.icon : "https://everything-amala.vercel.app/default-image.jpg"}
            />
        </Helmet>
    )
}
