      ...
      <div className="header__wrapper">
        <div className="header__info">
          ...
          <p className="header__info-text">
            Unleash your inner foodie! Discover top-rated {foodType === "calabar%2Ckitchen" ? "Calabar" : foodType} spots nearby and check reviews before heading there. <br /> Plus, you can save your top spots and share them with your foodie friends. Don't settle for mediocre meals, let us help you find the best {foodType === "calabar%2Ckitchen" ? "Calabar Kitchen" : foodType} around!
          </p>
